...
def test_dict_equivalence_classes():
    ...
    for name, d in classes.items():
        assert repeated_dumps_are_identical(d), name
        assert equivalent(d, marshal.loads(marshal.dumps(d))), name
...
def test_set_equivalence_classes():
    ...
    for name, s in classes.items():
        assert repeated_dumps_are_identical(s), name


def test_dict_from_set_order():
